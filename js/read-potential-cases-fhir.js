...
(async () => {
  ...
  await fs.writeFile("atrioventricular-block-complete-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("atrioventricular-block-complete-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
